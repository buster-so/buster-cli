...
main() {
    ...
    print_status "This script will download and install the Buster CLI binary"
    echo
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo "                       Examples: v0.4.2, v0.4.2-beta, 0.4.2-beta"
            echo "  --beta               Install latest beta/prerelease version"
            echo "  --help               Show this help message"
            echo
            echo "Examples:"
            echo "  $0                           # Install latest stable version"
            echo "  $0 --version v0.4.2          # Install specific stable version"
            echo "  $0 --version v0.4.2-beta     # Install specific beta version"
